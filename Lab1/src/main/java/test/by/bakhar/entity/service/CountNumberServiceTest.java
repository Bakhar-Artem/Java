...
public class CountNumberServiceTest {
    ...
    public Object[][] dataProviderInit() {
        return new Object[][]{
                {new DoubleArray(5.4, 76, 0, 1.9), 83.3, 3l, 0l},
                {new DoubleArray(0, 0, 0, 0), 0., 0l, 0l},
                {new DoubleArray(5.4, -75.14, -75.1, 65.17), -79.67, 2l, 2l},
                {new DoubleArray(5.4, 76, 0, 45.4), 126.8, 3l, 0l},
                {new DoubleArray(-5.4, 0, 1, 49), 44.6, 2l, 1l}
        };
    }
    ...
    public void testCountPositive(Object[] data) throws DoubleArrayException {
        int expected = Integer.valueOf((Integer) data[2]) ;
